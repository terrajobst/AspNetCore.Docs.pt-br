...
---
# <a name="host-and-deploy-razor-components-and-blazor"></a>Hospedar e implantar Componentes Razor e o Blazor
...
* [Blazor no lado do cliente](xref:host-and-deploy/razor-components-blazor/blazor)
* [Componentes Razor ASP.NET Core no lado do servidor](xref:host-and-deploy/razor-components-blazor/razor-components)
