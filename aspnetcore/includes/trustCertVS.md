<span data-ttu-id="a38f8-101">O Visual Studio exibe a caixa de diálogo a seguir:</span><span class="sxs-lookup"><span data-stu-id="a38f8-101">Visual Studio displays the following dialog:</span></span>
