...
* Inclui um controlador de diagnóstico que reúne a memória real Tine e os dados do GC para o aplicativo.
...
- Conjunto de trabalho: a memória física total (RAM) usada pelo processo. O conjunto de trabalho mostrado é o mesmo valor que o Gerenciador de tarefas pode exibir.
...
O gráfico anterior mostra um problema óbvio com a implementação dessa classe, pois ela mantém o aumento do uso da memória. Esse é um problema conhecido que está sendo acompanhado nesse [problema](https://github.com/aspnet/Home/issues/3110).
