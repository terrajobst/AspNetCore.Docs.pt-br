...
<span data-ttu-id="3d9e7-113">Nos exemplos a seguir:</span><span class="sxs-lookup"><span data-stu-id="3d9e7-113">In the examples that follow:</span></span>
