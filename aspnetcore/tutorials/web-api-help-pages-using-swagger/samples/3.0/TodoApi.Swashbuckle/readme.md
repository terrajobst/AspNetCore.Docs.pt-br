...
Para obter informações sobre como personalizar a interface do usuário, confira: [Personalizar a interface do usuário](/aspnet/core/tutorials/getting-started-with-swashbuckle?#customize-and-extend)
