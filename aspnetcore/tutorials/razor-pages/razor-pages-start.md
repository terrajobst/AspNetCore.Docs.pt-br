...
Este é o primeiro tutorial de uma série. [A série](xref:tutorials/razor-pages/index) ensina as noções básicas de criação de um aplicativo Web do Razor Pages do ASP.NET Core. No final da série, você terá um aplicativo que gerencia um banco de dados de filmes.  
