...
* Entity Framework Core-consulte https://docs.microsoft.com/en-us/ef/core/providers/index para obter mais informações sobre como referenciar o pacote específico do provedor de banco de dados.
...
### <a name="razor-class-library"></a>Biblioteca de classes Razor

Os projetos de biblioteca de classes Razor que fornecem componentes de interface do `RazorLangVersion` usuário para o MVC devem definir a propriedade no arquivo de projeto.
...
Para outras alterações significativas na versão 3,0, consulte o repositório de comunicado- https://github.com/aspnet/Announcements/issues?page=2&q=is%3Aissue+is%3Aopen+label%3A%22Breaking+change%22+label%3A3.0.0.
